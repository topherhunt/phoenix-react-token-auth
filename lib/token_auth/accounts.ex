defmodule TokenAuth.Accounts do
  import Ecto.Query, warn: false
  alias TokenAuth.Repo
  alias TokenAuth.Accounts.User
  ...
  def new_token_for_user(user) do
    ...
    Phoenix.Token.sign(TokenAuthWeb.Endpoint, @token_salt, data, signed_at: signed_at)
  end
  ...
  def verify_token_and_get_user_id(token) do
    ...
    case Phoenix.Token.verify(TokenAuthWeb.Endpoint, @token_salt, token, max_age: :infinity) do
